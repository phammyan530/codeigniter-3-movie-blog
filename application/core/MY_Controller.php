...
class MY_Controller extends CI_Controller {
    ...
    function __construct() {
        ...
        // ======== Load Library ========
        $this->load->library(array('session','form_validation','pagination', 'general', 'curl', 'ion_auth'));
    ...
    protected function load_theme($content = null, $layout = true) {
        ...
        if(count($this->config->item('active_menu')) > 0){
            $this->data['main_menus'] = $this->general->bootstrap_menu($this->config->item('active_menu'));
        }
